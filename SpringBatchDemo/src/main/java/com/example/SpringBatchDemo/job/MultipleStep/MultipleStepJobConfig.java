package com.example.SpringBatchDemo.job.MultipleStep;
...
/**
 * desc: 다중 step 활용 및 step to step 데이터 전달
 * run param: --spring.batch.job.names=multipleStepJob
 */
@Configuration
    ...
    public Step multipleStep2() {
        return stepBuilderFactory.get("multipleStep2")
                .tasklet((contribution, chunkContext) -> {
                    ...
                    // ExecutionContext를 통해서 다음 스탭에게 객체 전달 가능
                    ...
                    executionContext.put("someKey", "hi");
