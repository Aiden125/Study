...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        Book book = createBook("서서 JPA", 10000, 10);
    ...
    public void 주문취소() throws Exception {
        //given
        Member member = createMember();
        Book item = createBook("저적 JPA", 10000, 10);
        ...
        Assert.assertEquals("주문 취소된 상품은 그만큼 재고가 증가해야한다", 10, item.getStockQuantity());
    }
    ...
    public void 상품주문_재고수량초과() throws Exception {
        //given
        Member member = createMember();
        Item item = createBook("서서 JPA", 10000, 10);
        ...
        //then
        Assert.fail("재고 수량 부족 예외가 발생해야 한다"); // notEnough를 기대했는데 여기까지 오게돼서 fail로 됨
    }
